...
class Forum extends React.Component {
  ...
  componentDidMount() {
    axios
      .get("http://localhost:8080/usuario/foro/comentarios/ultimo")
      .then((res) => {
        ...
        <div className="ForumAll">
          ...
          <div className="Forum-cotent">
            <form className="o-form-foro" onSubmit={this.handlerButton}>
              ...
              <textarea
                name="comentario"
                placeholder="Aquí va tu maravilloso mensaje"
                className="o-comentario-foro"
            ...
            <div className="form-forum-cont">
              ...
              {this.state.comments.map((comments) => (
                <>
                  <ForumCard
                    isrc={user}
                    descript={comments.comentario}
                    timeD={"Escrito por " + comments.nombreUser}
                    likesD={comments.numeroLikes}
                  />
