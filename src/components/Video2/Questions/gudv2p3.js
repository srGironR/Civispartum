  ...
  render() {
    return (
      <div className="Good-place">
        ...
        <Link className="ttS" to="/V2P4">
          <button className="btnSgt" onClick={this.handlerButton}>
            <p>Siguiente</p>
          </button>
        </Link>
        <p className="descriptW">
          Viene planteado desde gobierno y busca modificar la constitución
          agregando alguna norma, y una estructuras que permitan el cuidado de
          los animales
        </p>
      </div>
    );
