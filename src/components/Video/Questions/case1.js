  ...
  render() {
    ...
    return (
        ...
        <div className="o-vid-containerFQ">            
            ...
            <Animated animationIn="fadeIn" animationOut="fadeOut" isVisible={true} animationInDelay="22000">
            <div className="QuestionsC">
            <Link to="/GoodC" className="QF"><QCard  descript="Si los cumple."/></Link>
            <Link to="/BadC" className="QF"><QCard  descript="No, para nada."/></Link>            
            </div> 
            </Animated>
