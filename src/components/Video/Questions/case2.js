      ...
      <div className="o-vid-containerFQ">
        ...
        >
          <div className="QuestionsC">
            <Link to="/GoodE" className="QF">
              <QCard descript="Marcar la opción que ella considera." />
            </Link>
            <Link to="/BadE" className="QF">
              <QCard descript="No, me da igual marcaré el tarjetón con una X." />
            </Link>
          </div>
        </Animated>
      </div>
